  ...
  const reviewsDatabase: Record<string, Review[]> = {
    ...
    sermier: [
      ...
      },
      {
        ...
        rating: 4,
        comment: 'Enak dan renyah bangett, tapi kalau harga bisa lebih murah lagi pasti lebih banyak yang beli. kurang hoki beli pas gak promo tp pengin',
    ...
    bahasa_arab: [
      ...
      },
      {
        ...
        userName: 'Naufal',
        rating: 5,
        comment: 'Cara ngajarnya santai dan gampang dipahami, nggak bikin tegang. Materinya dijelasin pelan-pelan dan disesuaikan sama kemampuan. Jadi makin pede belajar bahasa Arab.',
        ...
        helpfulCount: 3,
           ...
           {
        id: '6',
        userName: 'BAGAS ADI KUNCORO',
        rating: 5,
        comment: 'Penjelasan jelas dan langsung ke inti. Cocok buat pemula yang pengen mulai dari nol.',
        date: '2025-04-08T15:45:00Z',
        isVerified: true,
        helpfulCount: 1,
      },
           {
        id: '7',
        userName: 'Rina Alfi Naimah',
        rating: 5,
    ...
    konseling: [
      ...
      },
      {
        ...
        rating: 5,
        comment: 'Selama sesi rasanya nyaman dan nggak dihakimi. walaupun onine. Bisa cerita dengan bebas dan dapet sudut pandang baru yang bikin lebih tenang. Abis sesi rasanya lebih lega..',
        ...
        helpfulCount: 1,
            ...
            {
        id: '5',
        userName: 'Wulan kurniasih',
        rating: 5,
        comment: 'Konselornya nanggepinnya dengan serius walau via online dan responnya nggak menggurui. Pembahasannya juga masuk akal dan relevan sama masalah yang dihadapi.',
        ...
        helpfulCount: 1,
            ...
            {
        id: '6',
        userName: 'rizki putra aldiansyah',
        rating: 5,
        comment: 'kok bisa ya konselor bangun suasana, yang awalnya saya merasa berat dia mampu mengubah Suasananya aman dan suportif. Cocok buat yang butuh tempat cerita.',
        ...
        helpfulCount: 4,
            ...
            {
        id: '8',
        userName: 'Vivi Alvira D.',
        rating: 5,
        comment: 'Ngebantu saya banget buat ngenalin diri sendiri dan ngatur pikiran yang lagi ruwet',
    ...
    joki_akademik: [
      {
        id: '1',
        userName: 'Rina Cahyati',
        rating: 5,
        comment: 'Tugas makalah saya dikerjakan dengan sempurna! Dosen bahkan memberikan nilai A+. Kualitas penulisan sangat academic dan terstruktur. Sangat merekomendasikan!',
      ...
      },
      {
        ...
        rating: 5,
        comment: 'Essay saya untuk assignment sesuai dengan requirement profesor. Tim sangat responsif dan menerima revisi dengan baik. Proses cepat dan hasil memuaskan!',
        date: '2025-01-12T10:45:00Z',
        isVerified: true,
        helpfulCount: 19,
      },
      {
        ...
        rating: 5,
        comment: 'Research paper untuk skripsi saya dikerjakan dengan metodologi yang tepat. Referensi lengkap dan analisis mendalam. Terima kasih telah membantu menyelesaikan studi!',
        date: '2025-01-10T16:15:00Z',
        isVerified: true,
        helpfulCount: 16,
      },
      {
        id: '4',
        userName: 'Faisal Wirahman',
        rating: 5,
        comment: 'Presentasi dan slide deck untuk seminar dibuat dengan sangat profesional. Design menarik dan content terstruktur dengan baik. Sangat terkesan dengan kualitasnya!',
      ...
      },
      {
        ...
        rating: 4,
        comment: 'Tugas case study dikerjakan dengan baik. Analisisnya mendalam dan menjawab semua pertanyaan. Hanya perlu sedikit penyesuaian minor tapi overall sangat puas!',
